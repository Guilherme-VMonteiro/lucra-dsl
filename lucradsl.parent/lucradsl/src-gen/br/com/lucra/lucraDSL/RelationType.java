 ...
 * <!-- end-user-doc -->
 * @see br.com.lucra.lucraDSL.LucraDSLPackage#getRelationType()
 * @model
 * @generated
 */
public enum RelationType implements Enumerator
{
   ...
   * <!-- end-user-doc -->
   * @see #REFERS
   * @model literal="refers"
   * @generated
   * @ordered
   */
  public static final int REFERS_VALUE = 2;
